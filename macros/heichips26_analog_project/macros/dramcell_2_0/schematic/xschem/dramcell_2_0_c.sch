...
N -420 -30 -420 20 {lab=VGND}
N -420 -30 -350 -30 {lab=VGND}
N -350 -30 -350 0 {lab=VGND}
N -410 -180 -410 -140 {lab=VPWR}
N -410 -140 -350 -140 {lab=VPWR}
N -350 -160 -350 -140 {lab=VPWR}
N -350 40 -350 50 {lab=nReFr}
N -320 -500 -320 -340 {lab=CWBL}
N -380 -500 -380 -340 {lab=RBL}
N -420 -370 -420 -320 {lab=VGND}
N -420 -370 -350 -370 {lab=VGND}
N -350 -370 -350 -340 {lab=VGND}
N -410 -520 -410 -480 {lab=VPWR}
N -410 -480 -350 -480 {lab=VPWR}
N -350 -500 -350 -480 {lab=VPWR}
N -350 -300 -350 -200 {lab=RWL}
N -350 -570 -350 -540 {lab=nReFr}
N -620 -280 -620 -260 {lab=VPWR}
N -620 -120 -590 -120 {lab=VGND}
N -620 -70 -620 -50 {lab=VGND}
N -620 -280 -590 -280 {lab=VPWR}
N -620 -310 -620 -280 {lab=VPWR}
N -590 -280 -590 -230 {lab=VPWR}
N -620 -230 -590 -230 {lab=VPWR}
N -620 -70 -590 -70 {lab=VGND}
N -620 -90 -620 -70 {lab=VGND}
N -590 -120 -590 -70 {lab=VGND}
N -660 -230 -660 -120 {lab=RWL}
N -620 -180 -620 -150 {lab=nReFr}
N -620 -180 -590 -180 {lab=nReFr}
N -620 -200 -620 -180 {lab=nReFr}
N 480 -420 480 -400 {lab=VPWR}
N 480 -260 510 -260 {lab=VGND}
N 480 -210 480 -190 {lab=VGND}
...
N 480 -210 510 -210 {lab=VGND}
N 480 -230 480 -210 {lab=VGND}
N 510 -260 510 -210 {lab=VGND}
...
C {lab_pin.sym} 180 -290 2 0 {name=p12 sig_type=std_logic lab=nRBL}
...
C {devices/lab_pin.sym} -350 50 1 1 {name=l31 sig_type=std_logic lab=nReFr}
...
C {devices/lab_pin.sym} -350 -570 3 1 {name=l37 sig_type=std_logic lab=nReFr}
...
C {lab_wire.sym} -590 -180 2 0 {name=p5 sig_type=std_logic lab=nReFr}
...
C {lab_pin.sym} 480 -190 0 0 {name=p18 sig_type=std_logic lab=VGND}
C {lab_pin.sym} -420 20 0 0 {name=p20 sig_type=std_logic lab=VGND}
C {lab_pin.sym} -620 -50 0 0 {name=p21 sig_type=std_logic lab=VGND}
C {lab_pin.sym} -420 -320 0 0 {name=p22 sig_type=std_logic lab=VGND}
